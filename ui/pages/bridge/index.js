    ...
    <div className="swaps">
      <div className="swaps__container">
        <div className="swaps__header">
          ...
          <div className="swaps__title">Bridge</div>
          <div
          ...
          <Switch>
            ...
            <FeatureToggledRoute
              ...
              render={() => {
                ...
                return <Redirect to={{ pathname: BUILD_BRIDGE_QUOTE_ROUTE }} />;
              }}
            />
            <Route
            ...
            <FeatureToggledRoute
              ...
              render={() => {
                return aggregatorMetadata ? (
                  ...
                  <Redirect to={{ pathname: BUILD_BRIDGE_QUOTE_ROUTE }} />
                );
              }}
            />
            <Route
